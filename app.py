...
txt('**Master of Science** (Management Science: Business Analytics), *Ivey Business School at Western University*, Canada',
'2017-2018')
st.markdown('''
- GPA: `3.8/4.0`
...
txt('**Credit and Financial Analyst**, Treasury and Portfolio Management Group, Central 1 Credit Union (Contract Full-time), Toronto, Ontario, Canada',
'2022-Present')

txt('**Adjunct Professor**, The Business School, Centennial College (Contract Part-time), Toronto, Ontario, Canada',
'Summer 2022')

txt('**Associate, Middle Office Operations*, Private Wealth Group, Marret Asset Management Inc. (Permanent Full-time), Toronto, Ontario, Canada',
'2020-2021')

txt('**Corporate Financial Analyst**, Corporate Finance and Strategy Group, Vinzan International (Permanent Full-time), Toronto, Ontario, Canada',
'2018-2020')

txt('**Ptivate Equity Analyst**, Leverage Buyout Group, Adelaide Capital Investments (Contract Full-time), Toronto, Ontario, Canada',
'Summer 2018')
